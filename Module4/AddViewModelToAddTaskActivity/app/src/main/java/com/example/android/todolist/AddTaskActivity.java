    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                final AddTaskViewModel vm = ViewModelProviders.of(this, factory).get(AddTaskViewModel.class);

                // TODO (12) Observe the LiveData object in the ViewModel. Use it also when removing the observer
                vm.getTask().observe(this, new Observer<TaskEntry>() {
                    @Override
                    public void onChanged(@Nullable TaskEntry taskEntry) {
                        vm.getTask().removeObserver(this);
