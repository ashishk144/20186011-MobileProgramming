...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(UserPasswordKey != null && UserPhoneKey != null) {
            if (!UserPasswordKey.equals("UserPassword") && !UserPhoneKey.equals("UserPhone")) {
                ...
                if (dataSnapshot.child("Users").child(number).exists()) {
                    ...
                    if (usersData.getNumber().equals(number)) {
                        ...
                        if (usersData.getPassword().equals(password)) {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(MainActivity.this, "You have provided wrong password", Toast.LENGTH_LONG).show();
                        }
